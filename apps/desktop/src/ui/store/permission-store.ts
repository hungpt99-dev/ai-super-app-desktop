...
export const PERMISSION_META: Record<Permission, IPermissionMeta> = {
  ...
  [Permission.MemorySharedWrite]: { label: 'Shared Memory Write', description: 'Write to the workspace shared knowledge base', risk: 'standard' },
  [Permission.NetworkFetch]: { label: 'Internet Access', description: 'Allow module to make HTTP requests to the internet.', risk: 'high' },
  [Permission.AgentCall]: { label: 'Call Other Agents', description: 'Allow module to call other agents asynchronously.', risk: 'standard' },
  [Permission.ToolExecute]: { label: 'Execute Tools', description: 'Allow module to execute registered tools.', risk: 'standard' },
  [Permission.Filesystem]: { label: 'Filesystem Access', description: 'Allow module to read and write to the local filesystem.', risk: 'high' },
}
