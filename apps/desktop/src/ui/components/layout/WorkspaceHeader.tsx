/**
 * WorkspaceHeader.tsx — Header showing active workspace and agents.
 *
 * Features:
...
import { useWorkspaceTabsStore, type IWorkspaceAgent } from '../../store/workspace-tabs-store'
...
export function WorkspaceHeader({ className = '' }: IWorkspaceHeaderProps): React.JSX.Element {
    const {
        tabs,
        currentTabId,
        workspaceAgents,
