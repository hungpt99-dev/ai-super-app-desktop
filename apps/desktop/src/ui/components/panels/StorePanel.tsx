...
/**
 * StorePanel — "Module Store" coming-soon placeholder.
 *
 * Will be replaced with the live marketplace UI once the backend
 * marketplace service ships.
 */
export function StorePanel(): React.JSX.Element {
  return (
    <div className="flex h-full flex-col items-center justify-center gap-6 bg-[var(--color-bg)] p-8 text-center">
      ...
      <div>
        <h2 className="text-2xl font-bold text-[var(--color-text-primary)]">Module Store</h2>
