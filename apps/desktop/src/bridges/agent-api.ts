 ...
 *   - Agent run polling (claim pending run) and status reporting
 *
...
/**
 * Response from GET /v1/agents/poll.
...
/** Request body for PATCH /v1/agents/runs/{runID}. */
