...
import type { ILLMProvider, ILLMRequest, ILLMResponse, ILLMChunk, IToolCall } from '../interfaces.js'
...
export class OpenaiProviderAdapter implements ILLMProvider {
    ...
    private mapRequest(request: ILLMRequest) {
        ...
        const tools: ChatCompletionTool[] | undefined = request.tools?.map((t: any) => ({
            type: 'function',
            function: {
                name: t.name,
